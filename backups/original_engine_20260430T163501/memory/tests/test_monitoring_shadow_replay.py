...
from memory.monitoring import MemoryMonitoring
    ...
    rows = [
        {
            ...
            "result": {"status": "partial", "replayed": 2, "skipped": 1, "failed": 1, "remaining": 1},
        },
        {
            "timestamp": "2026-04-21T01:00:00",
            "action": "shadow_replay_spool",
            "result": {"status": "success", "replayed": 1, "skipped": 1, "failed": 0, "remaining": 0},
        },
    ]
    ...
    rows = [
        {
            "timestamp": "2026-04-21T00:00:00",
            "action": "shadow_replay_spool",
            "result": {"status": "partial", "replayed": 0, "skipped": 0, "failed": 2, "remaining": 2},
        }
    ]
    (mem / "maintenance_policy_log.jsonl").write_text(
        "\n".join(json.dumps(x, ensure_ascii=False) for x in rows) + "\n",
