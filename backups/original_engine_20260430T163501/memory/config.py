    ...
    "memory": {
        ...
        "retrieval_fusion": {
            ...
            "query_intent_source_prior": {
                ...
                "min_penalty": -0.22,
                "governance_keywords": [
                    "threshold", "审批", "审查", "人工确认", "maintenance", "policy", "review", "backlog", "queue", "config", "配置", "治理", "监控", "告警", "context snapshot"
                ],
                "governance_title_boost_keywords": ["maintenance", "policy", "threshold", "review", "config", "治理", "阈值", "审批"],
                "narrative_penalty_keywords": ["故事", "剧情", "黑帮", "科幻", "世界观", "episode", "chapter"],
...
def _default_workspace_dir() -> Path:
    ...
    return Path.home() / ".codex" / "memories" / "openclaw-memory-workspace"
...
def get_config() -> Dict[str, Any]:
    ...
    if security_cfg.get("recovery_material_file"):
        security_cfg["recovery_material_file"] = str(_resolve_path(workspace_dir, security_cfg["recovery_material_file"]))
    ...
    if monitoring_cfg.get("daily_report_markdown"):
        monitoring_cfg["daily_report_markdown"] = str(_resolve_path(workspace_dir, monitoring_cfg["daily_report_markdown"]))
