...
class AutoMemoryConfig:
    ...
    def from_dict(cls, raw: Dict[str, Any]) -> "AutoMemoryConfig":
        ...
        return cls(
            ...
            exclude_source_prefixes_for_index=list(data.get("exclude_source_prefixes_for_index", ["verify_canary", "test"])),
            exclude_source_prefixes_for_log=list(data.get("exclude_source_prefixes_for_log", ["verify_canary", "test"])),
