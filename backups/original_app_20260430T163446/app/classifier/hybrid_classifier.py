...
class HybridClassifier:
    def __init__(
        ...
        use_llm: bool = False,
        context_dependency_min_confidence: float = 0.8,
    ) -> None:
        self.rule_classifier = rule_classifier
        self.llm_classifier = llm_classifier
        self.threshold_manager = threshold_manager
        self.use_llm = bool(use_llm)
        self.context_dependency_min_confidence = float(context_dependency_min_confidence)
    ...
    def classify(self, text: str, context: Dict) -> Dict:
        ...
        if not category:
            ...
            context.get("has_code")
            and category in {"technical_doc", "configuration"}
            and confidence < self.context_dependency_min_confidence
        ):
        ...
        if not self.use_llm:
            return {
                ...
                "matched_rules": matched_rules,
                "llm_used": False,
                "reason": f"rule_fallback:{gray_reason}:llm_disabled",
