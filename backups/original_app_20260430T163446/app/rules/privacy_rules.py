...
PII_PATTERNS = {
    ...
    "internal_ip_port": r"\b(?:10\.\d{1,3}\.\d{1,3}\.\d{1,3}|192\.168\.\d{1,3}\.\d{1,3}|172\.(?:1[6-9]|2\d|3[0-1])\.\d{1,3}\.\d{1,3})(?::\d{2,5})\b",
...
def privacy_check(text: str) -> tuple[bool, list[str]]:
    ...
    return (not bool(result["has_sensitive"]), list(result["flags"]))
