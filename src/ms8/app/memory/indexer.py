...
class MemoryIndexer:
    ...
    def _is_excluded_source(self, memory: dict) -> bool:
        ...
        return any(source.startswith(prefix) for prefix in self.excluded_source_prefixes) or (
            "样本" in text and source.startswith("verify_canary")
        )
    ...
    def cleanup_excluded(self) -> dict:
        ...
        return {
            ...
            "removed": max(0, before - len(self._index)),
        }
