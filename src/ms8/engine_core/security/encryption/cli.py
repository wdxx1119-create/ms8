...
from .. import get_crypto_manager
from ..recovery import recover_with_recovery_key
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="ms8 security CLI")
    ...
    for action_name in ("status", "lock", "unlock", "enable", "disable", "recover"):
        sub.add_parser(action_name)
