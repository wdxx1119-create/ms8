...
class CompressionTests(unittest.TestCase):
    def test_preview_plan(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
                ...
                "settings": {
                    "memory": {
                        ...
                        "compression": {
                            ...
                            "keep_recent_count": 0,
                            "min_log_count": 0,
                            "report_dir": str(memory_dir / "compression_reports"),
                        },
                    }
                },
            }
            ...
            learning.file_store = _FakeFileStore(workspace / "MEMORY.md")  # type: ignore[assignment]
            learning.sqlite_store = _FakeSqliteStore()  # type: ignore[assignment]
