...
class BuiltInSkills:
    ...
    def install_built_in(self, skill_name: str) -> dict:
        ...
        if not skill_data:
            return {"status": "error", "error": f'Built-in skill "{skill_name}" not found'}
    ...
    def _get_skill_content(self, skill_name: str) -> dict | None:
...
```
''',
                "resources": {"pep8_cheatsheet.txt": "PEP 8 Style Guide Quick Reference\n..."},
            },
            "code-review": {
...
class SkillDiscovery:
    ...
    def get_relevant_skills(self, context: str, top_k: int = 3) -> list[dict]:
        ...
        for skill in all_skills:
            ...
            if hasattr(skill, "metadata") and skill.metadata:
                ...
                skill_category = (
                    ...
                    if hasattr(skill.metadata.category, "value")
                    else str(skill.metadata.category)
                )
            ...
            # Case 2: Skill object (from skills.py) - parse from content
                ...
                skill_description = skill.content.get(
                ...
                if frontmatter:
                    ...
                    try:
                        ...
                        print(f"[BuiltInSkills] Failed parsing frontmatter for skill '{skill_name}': {exc}")
                ...
                for trigger in skill_triggers:
                    ...
                    if trigger.startswith("/") and trigger.endswith("/"):
                        ...
                        try:
                            ...
                            print(f"[BuiltInSkills] Invalid trigger regex '{trigger}' in skill '{skill_name}': {exc}")
        ...
        scored_skills.sort(key=_score_key, reverse=True)
