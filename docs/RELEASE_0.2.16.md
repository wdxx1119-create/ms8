...
- Runs candidate validation only for `candidate/**` branches or explicit manual dispatch.
...
- [ ] Installed-wheel strict audit succeeds.
- [ ] CycloneDX SBOM validates and contains MS8 0.2.16.
